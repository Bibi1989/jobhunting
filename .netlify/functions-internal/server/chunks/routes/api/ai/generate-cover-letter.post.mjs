...
const generateCoverLetter_post = withCredits(async (event) => {
  ...
  const hasExistingDraft = typeof currentContent === "string" && currentContent.replace(/<[^>]+>/g, "").replace(/&nbsp;/g, " ").trim().length > 20;
  const extraInstructions = typeof additionalInstructions === "string" ? additionalInstructions.trim() : "";
...
export { generateCoverLetter_post as default };
//# sourceMappingURL=generate-cover-letter.post.mjs.map
